                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <?php //foreach($forms as $form):
                                      ...
                                      <td><input type="text" class="form__field" name="id" value="" readonly></td>
                                      <td><input type="text" class="form__field" name="id" value=""></td>
                                      <td><input type="text" class="form__field" name="id" value=""></td>
                                      <td><input type="text" class="form__field" name="id" value=""></td>
                                </tr>
                                <?php //endforeach; ?>
                    ...
                    <div class="slimScrollDiv" style="position: relative; overflow: auto; width: auto; height: 600px;">
                        <div class="table-responsive">
                            ...
                            <div class="card my-3 shadow no-b r-0">
                                ...
                                <?php  //$fields=Modules::run('forms/fields');  foreach($fields as $field): ?>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form__field" name="id" value="" readonly></td>
                                    <td><input type="text" class="form__field" name="form_id" value="" ></td>
                                    <td><input type="text" class="form__field" name="form_field" value=""></td>
                                    <td><input type="text" class="form__field" name="label" value=""></td>
                                    <td><textarea class="form__field" name="default_data" ></textarea></td>
                                    <td><input class="form__field" type="text" name="prompts" value=""></td>
                                    <td><input class="form__field" type="text" name="data_type" value=""></td>
                                    <td><input class="form__field" type="text" name="description" value=""></td>
