            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=site_url('activity-list')?>/<?php echo $obj_actv['id']; ?>">Activity List</a></li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="hidden" name="objective_id" value="<?php echo $obj_actv['id']; ?>">
                                   
                                    <textarea class="form-control" rows="3" readonly
                                       style="width: 100%;"><?php echo $obj_actv['objective_name']; ?></textarea>
                                </div>
